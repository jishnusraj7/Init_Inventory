...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/customers/css/customers.css' />">
</head>
<body>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="customers.header"></spring:message>
				</h1>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="customers as item">
								...
								<jsp:directive.include file="../customers/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/customers/js/customers.js?n=1' />"></script>
