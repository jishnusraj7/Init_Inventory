...
<link rel="stylesheet"
	href="<c:url value="/resources/mrp/itembomnutri/css/itembomnutri.css" />">

<link rel="stylesheet"
	href="<c:url value="/resources/common/template/plugins/momentpicker/angular-moment-picker.css" />">

<%-- <link rel="stylesheet"
	href="<c:url value="/resources/mrp/itembomnutri/css/modalpopup.css" />"> --%>

<%-- <link rel="stylesheet"
	href="<c:url value="/resources/mrp/itembomnutri/css/ui-bootstrap-2.5.0-csp.css" />">
 --%>
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div ng-controller="item_bom_nutri as item">
							...
							<jsp:directive.include file="../itembomnutri/form.jsp" />
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Select Ingredient</h4>
					</div>
					<div class="modal-body">

						<!-- <p>Some text in the modal.</p> -->
						<div class="col-lg-3 d-flex flex-row pl-2">
							<label for="dish">Ingredient</label> <select class="form-control"
								id="DishId" class="required" name="DishId"
								ng-disabled="disable_all" required ng-model="dishData[0].DishId"
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Link
							Data</button>
...
<script
	src="<c:url value="/resources/mrp/itembomnutri/js/itembomnutri.js?n=1" />"></script>
<script
	src="<c:url value='/resources/common/js/views/ButtonController.js?n=1' />"></script>
<%-- <script
	src="<c:url value='/resources/mrp/itembomnutri/js/ui-bootstrap-2.5.0.min.js' />"></script> --%>

<%-- <script
	src="<c:url value="/resources/mrp/itembomnutri/js/modalpopup.js" />"></script> --%>
