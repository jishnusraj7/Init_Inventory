...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/shops/css/shops.css' />">
</head>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="shops.header"></spring:message>
				</h1>
				...
				<div class="col-xs-12">
					...
					<div class="box">
						...
						<div class="box-body">
							...
							<div ng-controller="shops as item">
								...
								<jsp:directive.include file="../shops/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/shops/js/shops.js?n=1' />"></script>
