...
<%@page
	import="com.indocosmo.mrp.utils.core.persistence.enums.EnumMatsers.productionCostType"%>
<c:set var="enumValues" value="<%=productionCostType.values()%>" />
...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/prodcost/css/productioncost.css' />">
</head>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="prodcuctioncost.header"></spring:message>
				</h1>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="productioncost as item">
								...
								<jsp:directive.include file="../prodcost/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/prodcost/js/productioncost.js?n=1' />"></script>
