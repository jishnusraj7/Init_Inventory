...
<!-- custom css can include below -->
 <link rel="stylesheet"
	href="<c:url value='/resources/mrp/supplier/css/suppliersettings.css' />"> 
</head>
...
<div class="content-wrapper header_second" ng-app="mrp_app"
	...
	<div class="list-content-header" ng-controller="btn_ctrl">
		...
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="supplier.header"></spring:message>
			</h1>
 ...
 -->
			<div ng-hide="updateMessage" class="alert-box">
				<spring:message code="common.updateMessage"></spring:message>
			</div>
			<div ng-hide="supplierinuse" class="erroralert-box">
				<spring:message code="supplierinuse"></spring:message>
			</div>
			...
			<%-- <ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message
							code="common.menu.inventory.supplier"></spring:message></a></li>
			</ol> --%>
		</section>
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div ng-controller="supplierctrl as item">
							...
							<jsp:directive.include file="../supplier/form.jsp" />
...
<script
	src="<c:url value='/resources/mrp/supplier/js/supplier.js?n=1' />"></script>
