...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/uom/css/uom.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<section class="content-header content-header_second">
		<h1><spring:message code="uom.header"></spring:message></h1>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="uomctrl as item">
							...
							<jsp:directive.include file="../uom/form.jsp" />
						</div>
...
<script src="<c:url value='/resources/mrp/uom/js/uom.js?n=1' />"></script>
