...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/vouchers/css/vouchers.css' />">
</head>
<body>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="vouchers.header"></spring:message>
				</h1>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="vouchers as item">
								...
								<jsp:directive.include file="../vouchers/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/vouchers/js/vouchers.js?n=1' />"></script>
