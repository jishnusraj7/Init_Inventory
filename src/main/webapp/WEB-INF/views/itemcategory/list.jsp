...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/itemcategory/css/itemcategory.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<!-- Content Header (Page header) -->
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="itemcategory.header"></spring:message>
			</h1>
			...
			<%-- <ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message
							code="common.menu.inventory.itemcategory"></spring:message></a></li>
			</ol> --%>
		</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="item_category as item">
							...
							<jsp:directive.include file="../itemcategory/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/itemcategory/js/itemcategory.js?n=1' />"></script>
