...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/currencydetails/css/currencydetails.css' />">
</head>
...
<div class="content-wrapper header_second" ng-app="mrp_app"
	...
	<div class="list-content-header" ng-controller="btn_ctrl">
		...
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="currencydetails.header"></spring:message>
			</h1>

			  <!-- <div ng-hide="alertMessageStatus" class="alert-box" id="alertMessageId">
				 {{ alertMeaasge }}
			</div> -->
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message
							code="common.menu.inventory.currencydetails"></spring:message></a></li>
			</ol>
		</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="currency_details as item">
							...
							<jsp:directive.include file="../currencydetails/form.jsp" />
...
<script src="<c:url value='/resources/mrp/currencydetails/js/currencydetails.js?n=1' />"></script>
