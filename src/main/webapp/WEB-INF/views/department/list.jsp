...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/department/css/department.css' />">
</head>
				...
				<div class="col-xs-12">
					...
					<div class="box">
						...
						<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							...
							<div ng-controller="department as item">
								...
								<jsp:directive.include file="../department/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/department/js/department.js?n=1' />"></script>
