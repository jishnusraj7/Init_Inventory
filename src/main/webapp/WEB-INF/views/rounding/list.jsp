...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/rounding/css/rounding.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<section class="content-header content-header_second">
		<h1><spring:message code="rounding.header"></spring:message></h1>
			...
			<li><a href="#"><spring:message code="common.menu.inventory.rounding"></spring:message></a></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div ng-controller="roundingctrl as item">
							...
							<jsp:directive.include file="../rounding/form.jsp" />
						</div>
...
<script src="<c:url value='/resources/mrp/rounding/js/rounding.js?n=1' />"></script>
