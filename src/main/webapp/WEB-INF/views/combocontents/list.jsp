...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/combocontents/css/combocontents.css' />">
</head>
	...
	<!-- Content Header (Page header) -->
		...
		<div ng-hide="succ_alertMessageStatus" class="alert-box"
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#">Combo Contents<%-- <spring:message
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="area_code as item">
							...
							<jsp:directive.include file="../combocontents/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/combocontents/js/combocontents.js?n=1' />"></script>
