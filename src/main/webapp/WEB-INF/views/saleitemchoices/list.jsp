...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/saleitemchoices/css/saleitemchoices.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<!-- Content Header (Page header) -->
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="saleitemchoices.header"></spring:message>
			</h1>
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message code="common.menu.products"></spring:message></a></li>
				<li><a href="#"><spring:message
							code="common.menu.products.saleitemchoices"></spring:message></a></li>
			</ol>
		</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="sale_item_choices as item">
							...
							<jsp:directive.include file="../saleitemchoices/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/saleitemchoices/js/saleitemchoices.js?n=1' />"></script>
