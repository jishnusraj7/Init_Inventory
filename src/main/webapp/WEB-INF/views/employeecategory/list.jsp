...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/employeecategory/css/employeecategory.css' />">
</head>
<body>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>EMPLOYEE CATEGORY
					<%-- <spring:message code="department.header"></spring:message> --%>
				</h1>
			...
			<div ng-hide="err_alertMessageStatus" class="erroralert-box" id="err_alertMessageId">
				...
				<ol class="breadcrumb breadcrumb_position">
					...
					<li><a href="#"><spring:message
								code="common.menu.people"></spring:message></a></li>
					<li><a href="#">Employee Category<%-- <spring:message
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="choices as item">
								...
								<jsp:directive.include file="../employeecategory/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/employeecategory/js/employeecategory.js?n=1' />"></script>
