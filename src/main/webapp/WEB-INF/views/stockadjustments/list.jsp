...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/stockadjustments/css/stockadjustment.css' />">
<link rel="stylesheet"
	...
	<div class="list-content-header" ng-controller="btn_ctrl">
		...
		<section class="content-header content-header_second">
			...
			<ol class="breadcrumb breadcrumb_position" ng-hide="true">
				...
				<li><a href="#">Stock Adjustment<%-- <spring:message
							...
							<div class="btn-group searchbttn" role="group">
								<div class="dropdown dropdown-lg">
									<button type="button" class="btn btn-default dropdown-toggle"
										style="height: 30px;" id="clearFeilds" aria-expanded="false">
									...
									<div class="dropdown-menu dropdown-menu-right dropsize"
										...
										<form class="form-horizontal" role="form">
											...
											<div class="form-group">
												<div class="col-md-13">
													<label for="contain">Adjust Date</label>
													<div>
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div ng-controller="stockdisposal as item">
							...
							<jsp:directive.include file="../stockadjustments/form.jsp" />
...
<script
	src="<c:url value='/resources/mrp/stockadjustments/js/stockadjustment.js?n=1' />"></script>
<script
