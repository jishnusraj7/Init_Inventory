...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/salesdepartment/css/salesdepartment.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<!-- Content Header (Page header) -->
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="salesdepartment.header"></spring:message>
			</h1>
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message
							code="common.menu.setup.salesdepartment"></spring:message></a></li>
			</ol>
		</section>
			...
			<div class="col-xs-12">
				...
				<div class="box ">
					...
					<div class="box-body">
						...
						<div ng-controller="sales_department as item">
							...
							<jsp:directive.include file="../salesdepartment/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/salesdepartment/js/salesdepartment.js?n=1' />"></script>
