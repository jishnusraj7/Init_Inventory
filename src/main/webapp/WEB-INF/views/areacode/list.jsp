...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/areacode/css/areacode.css' />">
</head>
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" style="min-height: 563px;" ng-cloak>
		<div class="list-content-header" ng-controller="btn_ctrl">
	<!-- Content Header (Page header) -->
		<section class="content-header content-header_second">
			<h1>
				<spring:message code="areacode.header"></spring:message>
			</h1>
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message
							code="common.menu.setup.areacode"></spring:message></a></li>
			</ol>
		</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="area_code as item">
							...
							<jsp:directive.include file="../areacode/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/areacode/js/areacode.js?n=1' />"></script>
