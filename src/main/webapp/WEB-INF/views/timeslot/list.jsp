...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/timeslot/css/timeslot.css' />">
...
<jsp:directive.include file="../common/includes/common_module_header.jsp" />
...
<div class="content-wrapper header_second"  ng-app="mrp_app" id="mrp_App_Id" ng-cloak>
	...
	<section class="content-header content-header_second">
		<h1><spring:message code="timeslot.header"></spring:message></h1>
			...
			<li><a href="#"><spring:message code="common.menu.inventory.timeslot"></spring:message></a></li>
		</ol>
	</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
						<div ng-controller="timeslotctrl as item">
							...
							<jsp:directive.include file="../timeslot/form.jsp" />
						</div>
...
<script src="<c:url value='/resources/mrp/timeslot/js/timeslot.js?n=1' />"></script>
