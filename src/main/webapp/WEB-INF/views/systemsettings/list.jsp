...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/systemsettings/css/systemsettings.css' />">
</head>
...
<div class="content-wrapper header_second" ng-app="mrp_app"
	...
	<div class="list-content-header" ng-controller="btn_ctrl">
		...
		<section class="content-header content-header_second">
			<h1><spring:message code="systemsettings.header"></spring:message>
			</h1>
			...
			<ol class="breadcrumb breadcrumb_position">
				...
				<li><a href="#"><spring:message code="systemsettings.header"></spring:message></a></li>
			</ol>
		</section>
			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div ng-controller="systemsettingsctrl as item">

							<jsp:directive.include file="../systemsettings/form.jsp" />
						</div>
...
<script
	src="<c:url value='/resources/mrp/systemsettings/js/systemsettings.js' />"></script>
<script
