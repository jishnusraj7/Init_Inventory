...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/profitcategory/css/profitcategory.css' />">
	...
	<div class="content-wrapper header_second" ng-app="mrp_app"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="profitcategory.header"></spring:message>
				</h1>
			...
			<div ng-hide="err_alertMessageStatus" class="erroralert-box" id="err_alertMessageId">
				...
				<ol class="breadcrumb breadcrumb_position">
					...
					<li><a href="#"><spring:message
								code="common.menu.inventory.profitcategory"></spring:message></a></li>
				</ol>
			</section>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							...
							<div ng-controller="profit_category as item">
								...
								<jsp:directive.include file="../profitcategory/form.jsp" />
	...
	<script
		src="<c:url value='/resources/mrp/profitcategory/js/profitcategory.js?n=1' />"></script>
