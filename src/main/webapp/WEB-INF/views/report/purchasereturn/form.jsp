<div class="" id="purchase_return_report_form_div">
	<form class="form-horizontal" id="purchase_return_report_form">
		...
		<div class="form-group" id="form_div_source_department_code">
					<label for="department_code" class="col-sm-2 control-label"><spring:message
							code="purchasereturn.department"></spring:message> </label>
					<div class="col-sm-6">
						<div class="input-group col-sm-10 classItem1">
							<input type="hidden" name="epartment_id" id="department_id"
								...
								ng-disabled="true" placeholder="Code">
