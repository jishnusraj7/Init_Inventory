	<link rel="stylesheet"
		href="<c:url value="/resources/mrp/report/prodbalancereport/css/prodbalancereport.css"/>">
...
<div class="" id="purchaseorder_report_form_div">
    ...
    padding-bottom: 30px;">
		<md-radio-button value="2" class="md-primary">Shop</md-radio-button> <md-radio-button
			value="1">Customer </md-radio-button>  </md-radio-group>


		
		<div class="form-group" id="form_div_startdate_bal">
			<label for="startdate" class="col-sm-2 control-label lb shps1">Select A Date:<i
				class="text-danger">*</i></label>
			<div class="col-sm-2">
				<div class="input-group col-sm-12">
					<div class="right-inner-addon" id="form_div_startdate_bal">
					...
					<span class="input-group-addon" min="0" max="99" number-mask=""
						id="form_div_startdate_error_bal" style="display: none;"><i
						class="fa fa-question-circle red-tooltip" data-toggle="tooltip"
						data-placement="bottom" title=""
						data-original-title="<spring:message code="report.dateerror"></spring:message>"></i></span>
				</div>
			</div>
		</div>
