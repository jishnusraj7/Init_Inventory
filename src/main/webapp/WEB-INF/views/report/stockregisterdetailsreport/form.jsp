<div class="" id="stock_register_details_report_form_div">
	<form class="form-horizontal" id="stock_register_details_report_form">
...
<!-- 
				...
				<div class="form-group" id="div_department_code1">
					<label for="department_code1" class="col-sm-2 control-label"><spring:message
							code="stockregisterdetailreport.department"></spring:message><i class="text-danger">*</i></label>
					<div class="col-sm-6">
