...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/reasons/css/reasons.css' />">
</head>
<body>
	...
	<div class="content-wrapper header_second" id="mrp_App_Id"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="reasons.header"></spring:message>
				</h1>
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="reasons as item">
								...
								<jsp:directive.include file="../reasons/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/reasons/js/reasons.js?n=1' />"></script>
