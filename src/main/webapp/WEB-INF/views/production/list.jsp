...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/production/css/production.css' />">
...
<body>
	...
	<div class="content-wrapper header_second" ng-app="mrp_app"
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<section class="content-header content-header_second">
				<h1>
					<spring:message code="dailyproduction.header"></spring:message>
				</h1>
							...
							<div class="input-group-btn">
								<div class="btn-group searchbttn" role="group">
									<div class="dropdown dropdown-lg">
										...
										<div class="dropdown-menu dropdown-menu-right dropsize"
											...
											<form class="form-horizontal" role="form">
												...
												<div class="form-group">
													<div class="col-md-13">
														<label for="contain">Prod Date</label>
												...
												<div class="form-group">
													<label for="contain">Prod No:</label> <input
											...
											<!-- <div class="form-group">
												<label for="filter">Department</label>
												 <select
													id="deptInPrd" class="form-control"
													name="department_id_prd"
													ng-init="department_id_prd=departmentListPrd[0]"
													ng-options="v.id as v.name for v in departmentListPrd"
													ng-model="department_id_prd">
										...
										<!-- 		<select ng-model="selectedCountry.countryId"
													ng-options="country.countryId as country.name for country in chooseCountries"></select>
 -->
												<!-- <div class="form-group">
				...
				<div class="col-xs-12">
					...
					<div class="box">
						...
						<div class="box-body">
							...
							<div ng-controller="dailyproduction as item">
 ...
 --%>
	...
	<script
		src="<c:url value='/resources/mrp/production/js/dailyproduction.js?n=1' />"></script>
	<script
