...
<link rel="stylesheet"
	href="<c:url value='/resources/mrp/kitchen/css/kitchen.css' />">
</head>
<body>
		...
		<div class="list-content-header" ng-controller="btn_ctrl">
			...
			<div ng-hide="err_alertMessageStatus" class="erroralert-box" id="err_alertMessageId">
				...
				<ol class="breadcrumb breadcrumb_position">
					...
					<li><a href="#">Kitchen<%-- <spring:message
...
<jsp:directive.include file="../common/includes/common_popup_form.jsp" />
							<div ng-controller="kitchen as item">
								...
								<jsp:directive.include file="../kitchen/form.jsp" />
	...
	<script	src="<c:url value='/resources/mrp/kitchen/js/kitchen.js?n=1' />"></script>
