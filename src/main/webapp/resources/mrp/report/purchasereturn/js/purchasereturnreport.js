var myApp = angular.module('purchase_return_report_app', [ 'ngMaterial' , 'ngMessages' , 'common_app' ,'checklist-model']);

myApp.controller('purchaseReturnCtrlr', purchaseReturnCtrlr);

function purchaseReturnCtrlr($scope, $http, $mdDialog ,$rootScope, DTOptionsBuilder,
...
$(document).on('keyup','#form_div_dest_department_code input',function(e){
	...
	*/
		...
		$("#btn_finalize").click(function(){
			...
			if($("#select_report").val() == "number:11"){
			...
			for(var i=0;i<$scope.selectedItemList.length;i++ )
				...
				$window.open("../purchaseReturnreport/PurchaseReturn Report?&option="+option+"&stock_item_id="+$scope.stock_iem_Ids+"&department_id="+parseInt($scope.formData.department_id)+"&startDate="+startdate+"&endDate="+enddate+"", '_blank');
				...
				//	}
					...
					//$window.open("../stockoutreport/Stockout Report?option="+option+"&stockItemId="+$scope.stock_iem_Ids+"&sourceDepartmentId="+parseInt($scope.formData.source_department_id)+"&destDepartmentId="+parseInt($scope.formData.dest_department_id)+"&startdate="+startdate+"&enddate="+enddate+"", '_blank');
					 ...
					 var link=document.createElement('a');
			    	    link.href="../purchaseReturnreport/PurchaseReturn Report?option=0&stock_item_id="+$scope.stock_iem_Ids+"&department_id="+parseInt($scope.formData.department_id)+"&startDate="+startdate+"&endDate="+enddate+"";
...
angular.bootstrap(document.getElementById("purchase_return_report_app"), ['purchase_return_report_app']);