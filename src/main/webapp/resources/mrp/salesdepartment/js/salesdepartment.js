...
mrpApp.controller('sales_department', sales_department);

function sales_department($controller,$compile,$timeout,$scope, $http, $mdDialog ,$rootScope, DTOptionsBuilder,DTColumnBuilder,
...
/*$("#form_div_description").hide();*/
       ...
       /* set_sub_menu("#settings");						
        setMenuSelected("#sales_department_left_menu");	*/		//active leftmenu
        manageButtons("add");
...
//    	generate number
	...
	function edit(row_data,cur_row_index,event) {									
		...
		$scope.formData = {id:response.data.editDet.id,name:response.data.editDet.name,code:response.data.editDet.code,
				description:response.data.editDet.description,sales_account_code:response.data.editDet.sales_account_code,
				purchase_account_code:response.data.editDet.purchase_account_code,stock_account_code:response.data.editDet.stock_account_code,
				cogs_account_code:response.data.editDet.cogs_account_code,wages_account_code:response.data.editDet.wages_account_code,
				gst_collected_account_code:response.data.editDet.gst_collected_account_code,gst_paid_account_code:response.data.editDet.gst_paid_account_code}
		...
		$mdDialog.show(confirm).then(function() {
			...
			$http({
				...
				if(response.data==0)
				{
					...
					$rootScope.$broadcast('on_AlertMessage_ERR','Sales Department '+FORM_MESSAGES.ALREADY_USE);
