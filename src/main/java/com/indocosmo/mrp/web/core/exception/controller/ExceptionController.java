package com.indocosmo.mrp.web.core.exception.controller;
...
public class ExceptionController {
	...
	public ModelAndView getDefaultErrorHandler(HttpServletRequest request , HttpServletResponse response ,/* CustomException
																										 * customException */
			Exception ex) {
