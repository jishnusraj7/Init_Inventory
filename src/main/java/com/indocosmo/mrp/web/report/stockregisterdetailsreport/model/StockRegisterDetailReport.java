package com.indocosmo.mrp.web.report.stockregisterdetailsreport.model;
...
@Entity
public class StockRegisterDetailReport extends GeneralModelBase{
	...
	@Transient
	private List<StockRegisterDetailReport> stockRegisterDetailsReport;
	...
	public List<StockRegisterDetailReport> getStockRegisterDetailsReport() {
		return stockRegisterDetailsReport;
	}

	public void setStockRegisterDetailsReport(List<StockRegisterDetailReport> stockRegisterDetailsReport) {
		this.stockRegisterDetailsReport = stockRegisterDetailsReport;
	}
