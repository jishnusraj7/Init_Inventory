/*package com.indocosmo.mrp.web.report.productionprofit.controller;
...
public class ProductionProfitController extends ViewController<ProdBomReportModel, ProdBomReportDao, ProdBomReportService> {
	
	public static final Logger logger = Logger.getLogger(ProductionProfitController.class);
