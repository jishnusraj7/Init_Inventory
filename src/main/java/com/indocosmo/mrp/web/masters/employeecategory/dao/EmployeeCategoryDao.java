...
public class EmployeeCategoryDao extends MasterBaseDao<EmployeeCategory> implements IEmployeeCategoryDao{

	/**
	 * @param context
	 */
	public EmployeeCategoryDao(ApplicationContext context) {
	 ...
	 */
	@Override
	public EmployeeCategory getNewModelInstance() {
	...
	public JsonArray getMastersRowJson() throws Exception{
		...
		final String sql="SELECT id,code,name FROM "+ getTable() + " WHERE  (is_deleted=0 OR is_deleted IS NULL)";
