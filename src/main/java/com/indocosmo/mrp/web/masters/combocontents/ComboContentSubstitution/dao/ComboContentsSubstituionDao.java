...
public class ComboContentsSubstituionDao extends GeneralDao<ComboContentsSubstituion> implements IComboContentsSubstituionDao {

	/**
	 * @param context
	 */
	public ComboContentsSubstituionDao(ApplicationContext context) {
	...
	@Override
	public ComboContentsSubstituion getNewModelInstance() {

		return new ComboContentsSubstituion();
	}
	...
	public String getTable() {
		...
		return "combo_content_substitutions";
	}
	 ...
	 */
	@Override
	public void save(List<ComboContentsSubstituion> itemList) throws Exception {
		String stockODtlIdList = "";
		String wherePart = "";

		final Integer stockOutId = itemList.get(0).getCombo_content_id();
		for (ComboContentsSubstituion stockOutItem : itemList) {
		...
		final String markAsDeletedSQl = "DELETE FROM " + getTable()+ "  WHERE combo_content_id=" + stockOutId	+ "" + wherePart + ";";
		...
		try {
			...
			for (ComboContentsSubstituion stockOutItem : itemList) {
				...
				if (stockOutItem.getCombo_content_id() != null && stockOutItem.getId() != null) {
