package com.indocosmo.mrp.web.masters.customertypes.controller;
...
public class CustomerTypeController extends MasterBaseController<CustomerType, CustomerTypeDao, CustomerTypeService> {
	
	/* (non-Javadoc)
	 * @see
	 * com.indocosmo.mrp.web.core.base.controller.BaseController#getService() */
	@Override
	public CustomerTypeService getService() {
	
		return new CustomerTypeService(getCurrentContext());
	}
