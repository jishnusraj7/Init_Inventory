...
public class ChoicesDao extends MasterBaseDao<Choices> implements IChoicesDao{

	/**
	 * @param context
	 */
	public ChoicesDao(ApplicationContext context) {
	 ...
	 */
	@Override
	public Choices getNewModelInstance() {
