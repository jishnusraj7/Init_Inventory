 ...
 *
 */
public class ShopDBDao extends GeneralDao<ShopDBSettings> implements IShopDBDao{

	public ShopDBDao(ApplicationContext context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	@Override
	public ShopDBSettings getNewModelInstance() {

		return new ShopDBSettings();
	}
	 ...
	 */
	@Override
	public List<ShopDBSettings> getList() throws Exception {
		String SQL;
		List<ShopDBSettings> testbom;
		try{
	...
	public void save(List<ShopDBSettings> itemList) throws Exception {
		String itemBomItemList = "";
		String wherePart = "";

		final Integer itemBomstockId = itemList.get(0).getShop_id();

		for (ShopDBSettings bomItem : itemList) {
		...
		try {
			...
			/*if (itemBomItemList.length() > 0)
				super.save(itemList);*/
			for (ShopDBSettings itemBomsItem : itemList) {
	 ...
	 */
	@Override
	public List<ShopDBSettings> getHqTableRowListToImport()throws Exception{
