package com.indocosmo.mrp.web.masters.combocontents.ComboContentSubstitution.controller;
...
@Controller
@RequestMapping("/combocontentsubstitions")
public class ComboContentsSubstituionController extends ViewController<ComboContentsSubstituion, ComboContentsSubstituionDao, ComboContentsSubstituionService> {
	
	/* (non-Javadoc)
	 * @see
	 * com.indocosmo.mrp.web.core.base.controller.BaseController#getService() */
	@Override
	public ComboContentsSubstituionService getService() {
	
		return new ComboContentsSubstituionService(getCurrentContext());
	}
