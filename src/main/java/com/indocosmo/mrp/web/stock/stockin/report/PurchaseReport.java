...
public class PurchaseReport extends AbstractITextPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model,Document document, PdfWriter writer, HttpServletRequest request,
		...
		final Font fontChange = new Font(Font.getFamily("TIMES_ROMAN"),11,Font.BOLD);
		...
		headerCell.setPhrase(new Phrase("Purchase Order No.", font));
		headerTable.addCell(headerCell);
	...
	/*	if(combine_mode==0)
		...
		*/
		...
		listTable.setWidths(new float[] {2.725f,0.88375f,0.88375f,1.08375f,0.68375f});
		...
		setCellBorder(.3f,.3f,.3f,0f,listCell);
		listCell.setPhrase(new Phrase("Amt", font));
		listTable.addCell(listCell);
		
		setCellBorder(.3f,.3f,.3f,0f,listCell);
		listCell.setPhrase(new Phrase("Tax", font));
		listTable.addCell(listCell);
		...
		if(currency.trim()=="" || currency==null){
			listCell.setPhrase(new Phrase("Total :", fontChange));
			
		}else{
			listCell.setPhrase(new Phrase("Total ("+currency+"):", fontChange));
		}
		...
		listCell.setPhrase(new Phrase(getNumberWithDecimal(totalAmt), fontChange));
		listCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		listTable.addCell(listCell);
		
		setCellBorder(0f,.3f,.3f,0f,listCell);
		listCell.setPhrase(new Phrase(getNumberWithDecimal(taxTtlAmt), fontChange));
		listCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		listTable.addCell(listCell);
		...
		if(currency.trim()=="" || currency==null){
			listCell.setPhrase(new Phrase("Grand Total :", fontChange));
			
		}else{
			listCell.setPhrase(new Phrase("Grand Total ("+currency+"):", fontChange));
		}
		...
		listCell.setPhrase(new Phrase(getNumberWithDecimal(grandTtl), fontChange));
		listCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		listTable.addCell(listCell);
		...
		*/
		...
		footerCell.setPhrase(new Phrase("Storekeeper Sign                                                                                 Authroized Sign",dataContentFont));
		footerTable.addCell(footerCell);
