 ...
 * 
 */
package com.indocosmo.mrp.web.stock.war.model;
...
@Entity
@Table(name ="mrp_dept_stock_item")
public class StockWarModel extends GeneralModelBase{
	@Pk
	...
	public String toString() {
		return "StockWarModel [deptStockId=" + deptStockId + ", deptId=" + deptId + ", stockId=" + stockId
				+ ", previousRate=" + previousRate + ", previousQty=" + previousQty + ", inRate=" + inRate + ", inQty="
				+ inQty + ", warRate=" + warRate + ", createdDate=" + createdDate + ", updatedDdate=" + updatedDdate
				+ ", isDeleted=" + isDeleted + ", getDeptStockId()=" + getDeptStockId() + ", getDeptId()=" + getDeptId()
				+ ", getStockId()=" + getStockId() + ", getPreviousRate()=" + getPreviousRate() + ", getPreviousQty()="
				+ getPreviousQty() + ", getInRate()=" + getInRate() + ", getInQty()=" + getInQty() + ", getWarRate()="
				+ getWarRate() + ", getCreatedDate()=" + getCreatedDate() + ", getUpdatedDdate()=" + getUpdatedDdate()
